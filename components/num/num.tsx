...
export const Num = () => {
  return (
    <div
      className={`${styles.num} h-[900px] md:h-[900px] xl:h-[600px] overflow-visible`}
    >
      <div className="container relative mx-auto overflow-visible text-koiiblue">
        ...
        <div className="botvector absolute right-0 bottom-[-2rem] xl:bottom-[-6rem]">
          <Image src="/images/vector/arrow-left.svg" width={854} height={162} />
        </div>
        <div className="relative flex flex-col xl:flex-row pt-[3rem] xl:pt-[6rem] items-center place-content-evenly">
