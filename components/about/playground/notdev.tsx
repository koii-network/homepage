...
export const Notdev = () => {
  ...
  return (
    <div className={` heroabout lg:h-[740px]`}>
      <div
        className="h-[738px] lg:h-[925px] relative z-[2]"
        style={{
      ...
      >
        <div className="container">
          <div className="flex z-20 flex-col relative pt-[13rem] md:pt-[18rem] lg:pt-[23rem] text-center items-center">
            <div className="title text-lightmint font-semibold text-[35px] md:text-[45px] max-w-[252px] md:max-w-[460px]">
              Not a developer?
            </div>
            <div className="sub-title text-white text-[14px] font-normal leading-[24px] pt-[20px] pr-[30px] lg:pt-[30px] lg:text-[16px] lg:max-w-[620px]">
              <p>
