  ...
  return (
    <div className={`${styles.nightsky} h-[900px] md:h-[1000px]`}>
      ...
      <div className="star-text md:text-2xl flex md:pl-[35rem] text-white w-auto">
          <span className="relative bottom-[16rem] md:bottom-[3rem] left-[12rem] md:left-[5rem]">Identity</span>
          <span className="relative bottom-[10rem] md:left-[5rem] left-[13rem] md:top-[4rem] opacity-40">Creativity</span>
          <span className="relative right-[5rem] md:right-[30rem] bottom-[1rem] md:top-4[rem] opacity-20">Content</span>
          <span className="relative top-[5rem] md:top-[11rem] md:right-[31rem] opacity-80">Rewards</span>
          <span className="relative top-[8rem] md:top-[15rem] right-[15rem] md:right-[54rem] opacity-60">Attention</span>
      </div>
    <div className="icebergtext md:text-2xl flex flex-row-reverse relative text-[#171753]">
        <span className="relative right-[5rem] md:right-[18rem] top-[13rem] md:top-[13rem]">Free Crypto</span>
        <span className="relative right-[4rem] md:right-[19rem] top-[19rem] md:top-[24rem]">Amazing Developer Tools</span>
    </div>
