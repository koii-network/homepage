...
export const Hero = () => {
  return (
    <div className="relative flex justify-center bg-gradient-to-b from-faux-azure-mist via-lightmint to-mint pt-40 pb-165 lg:pb-115">
      <div className="relative flex w-full flex-col items-center justify-center px-8">
        <div className="relative z-30 flex flex-col lg:flex-row items-center justify-center lg:justify-between lg:gap-80 pb-80 text-koiipurpledark">
          <div className="flex flex-col items-center lg:mb-auto lg:mt-16 w-full">
            ...
            <span className="w-full pt-7 font-sans text-base leading-[22px] mr-auto">
              Koii’s tools and support program empower you to make it happen
              fast.
            </span>
            <a href="#founders-form" className="mr-auto">
              <Button
          ...
          <div className="mt-16 h-80 lg:h-106 w-full">
            <ReactPlayer
