...
export const PartnersList = () => {
  ...
  return (
    <>
      {isLgBreakpoint ? (
        <div className="flex z-40 flex-wrap justify-center w-[90%] md:w-[480px] xl:w-[670px] md:gap-2 xl:gap-4 xl:gap-x-10 mb-[10px] md:mb-[20px]  xl:mb-[30px]">
        ...
        <div className="flex flex-col items-center">
          ...
          <div className="flex z-40 flex-wrap justify-center w-[90%] md:w-[640px] xl:w-[776px] md:gap-2 xl:gap-4 xl:gap-x-4 mb-[30px] md:mb-[30px]  xl:mb-[68px]">
