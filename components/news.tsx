...
export const News = () => {
    ...
    <div className="text-koiiblue ">
        <h2 className="text-center md:text-left md:pl-36 pt-2 text-5xl">In the News</h2>
        <p className="text-center md:text-left md:pl-36 pt-10 md:pt-2 text-xs">Catch Up on all the Latest</p>
