      ...
      <div className="container">
        <div className="relative z-10 pt-[15rem]">
          <div className="flex flex-col text-center">
            ...
            <div className="text-[20px] md:text-[40px] self-center pt-[1rem] text-white lg:w-[800px]">
              Koii is a blockchain project built for media, not just currency.
            </div>
          </div>
          <div className="relative flex flex-col md:flex-row pt-[2rem] md:mx-[-5rem] lg:mx-0 lg:pt-[3rem] items-center place-content-evenly">
